...
_calc PROC
	...
	; завантажити третій параметр який має відносно esp зміщення +8 байт
	mov eax, [ebp+16]; D
	div Two

	sub ebx, eax
	
	; завантажити другий параметр який має відносно esp зміщення +8 байт
	mov eax, [ebp+12]; B
	cbw
	cwd
	mul Four
	...
	; занести параметри функції в стек (arg1)
	push eax
	; викликати С функцію print
	call _print
	; видалити параметри print зі стеку додаванням до esp числа 4
	add esp,4
